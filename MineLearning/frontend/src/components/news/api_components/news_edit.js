...
import { ChangeNew, GetNewDetail } from '../../../services/api/news/news_service';
...
import Delete_New_Modal from '../../../modals/news/delete_new_form';

class News_Edit_Component extends Component {
    constructor(props) {
        super(props);
        this.state = {
            slug: '',
    ...
    componentDidMount() {
        ...
        GetNewDetail(this.props.match.params.new).then(response => {
            this.setState({
    ...
    render() {
        return (
            <div className="simple-login-container">
                ...
                <Delete_New_Modal data={this.state.slug_old} />
            </div>
        )
    }
}

export default News_Edit_Component;